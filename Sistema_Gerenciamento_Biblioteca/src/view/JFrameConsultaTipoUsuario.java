...
public class JFrameConsultaTipoUsuario extends javax.swing.JFrame {
    ...
    private String query = "SELECT codigo_tipo_usuario AS ID, nome AS Nome, administrativo AS Administrativo, atendimento AS Atendimento FROM tipo_usuario ORDER BY nome";
    
    private ResultSetTableModel result;
    private final TableRowSorter< TableModel > filter;

    public JFrameConsultaTipoUsuario(boolean select, boolean disconnectOnClose, TipoUsuario tipoUsuario) throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Consulta de Tipo Usuário");
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        JFrameCrudTipoUsuario jFrameCRUD;
        jFrameCRUD = new JFrameCrudTipoUsuario(null, false);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(row != -1) {
            ...
            try {
                ...
                JFrameCrudTipoUsuario jFrameCRUD;
                jFrameCRUD = new JFrameCrudTipoUsuario(tipoUsuario, false);
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if(row != -1) {
            ...
            this.tipoUsuario.setCodigo(codigo);
