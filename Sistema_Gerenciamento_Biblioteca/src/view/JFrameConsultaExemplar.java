...
public class JFrameConsultaExemplar extends javax.swing.JFrame {
    ...
    private String query = "SELECT codigo_exemplar AS ID, qtd_copias AS Copias, titulo AS Livro FROM exemplar INNER JOIN livro ON exemplar.codigo_livro = livro.codigo_livro ORDER BY Livro";
    
    private ResultSetTableModel result;
    private final TableRowSorter< TableModel > filter;

    public JFrameConsultaExemplar(boolean select, boolean disconnectOnClose, Exemplar exemplar) throws Exception {
        initComponents();
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        try {
            JFrameCrudExemplar jFrameCRUD;
            jFrameCRUD = new JFrameCrudExemplar(null, false);
            ...
            Logger.getLogger(JFrameConsultaExemplar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(row != -1) {
            ...
            try {
                ...
                JFrameCrudExemplar jFrameCRUD;
                jFrameCRUD = new JFrameCrudExemplar(exemplar, false);
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if(row != -1) {
            ...
            this.exemplar.setCodigo(codigo);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaExemplar(false, true, null).setVisible(true);
                } catch (Exception ex) {
                    LogTrack.getInstance().addException(ex, true, null);
                }
            }
