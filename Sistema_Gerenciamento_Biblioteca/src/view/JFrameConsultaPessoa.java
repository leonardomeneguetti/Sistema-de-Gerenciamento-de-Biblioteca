...
public class JFrameConsultaPessoa extends javax.swing.JFrame {
    private Pessoa pessoa;
    private boolean select;
    private boolean disconnectOnClose;
    
    private String query = "SELECT codigo_pessoa as ID, nome_completo as Nome, data_nascimento AS Nascimento, cpf AS CPF, rg AS RG, orgao_emissor AS OrgãoEmissor, cidade AS Cidade, estado AS Estado, telefone AS Telefone, email AS Email FROM pessoa ORDER BY Nome";
    
    private ResultSetTableModel result;
    private final TableRowSorter< TableModel > filter;

    public JFrameConsultaPessoa(boolean select, boolean disconnectOnClose, Pessoa pessoa) throws Exception {
        initComponents();
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        JFrameCrudPessoa jFrameCRUD;
        jFrameCRUD = new JFrameCrudPessoa(null, false);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(row != -1) {
            ...
            try {
                ...
                JFrameCrudPessoa jFrameCRUD;
                jFrameCRUD = new JFrameCrudPessoa(data, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaPessoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaPessoa(false, true, null).setVisible(true);
                } catch (Exception ex) {
                    LogTrack.getInstance().addException(ex, true, null);
                }
            }
