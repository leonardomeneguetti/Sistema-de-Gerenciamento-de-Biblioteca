...
public class JFrameConsultaUsuario extends javax.swing.JFrame {
    ...
    private String query = "SELECT codigo_usuario as ID, nome_completo as Nome, data_nascimento AS Nascimento, cpf AS CPF, rg AS RG, orgao_emissor AS OrgãoEmissor, cidade AS Cidade, estado AS Estado, telefone AS Telefone, email AS Email , senha_acesso AS Senha FROM usuario ORDER BY Nome";
    
    private ResultSetTableModel result;
    private final TableRowSorter< TableModel > filter;

    public JFrameConsultaUsuario(boolean select, boolean disconnectOnClose, Usuario usuario) throws Exception {
        initComponents();
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        try {
            JFrameCrudUsuario jFrameCRUD;
            jFrameCRUD = new JFrameCrudUsuario(null, false);
            ...
            Logger.getLogger(JFrameConsultaUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(row != -1) {
            ...
            try {
                ...
                JFrameCrudUsuario jFrameCRUD;
                jFrameCRUD = new JFrameCrudUsuario(usuario, false);
